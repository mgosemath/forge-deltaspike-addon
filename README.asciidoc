== forge-deltaspike-addon
:idprefix: id_ 
(choose one, do not modify, then add a second sentence with a brief description, starting with - "The forge-deltaspike-addon addon enables blah blah...)
...
<dependency>
   ...
   <artifactId>forge-deltaspike-addon</artifactId>
